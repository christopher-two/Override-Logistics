...
import org.override.logistics.data.auth.api.ExternalAuthResult
...
interface GoogleAuthManager {
     ...
     * @return Un [org.override.logistics.data.auth.api.ExternalAuthResult] que encapsula el éxito (con token),
