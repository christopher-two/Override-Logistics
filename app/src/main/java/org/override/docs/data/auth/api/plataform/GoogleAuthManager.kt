package org.override.docs.data.auth.api.plataform

import android.content.Intent
import androidx.activity.result.IntentSenderRequest
import com.google.firebase.auth.AuthResult
import org.override.docs.data.auth.api.ExternalAuthResult
...
interface GoogleAuthManager {
     ...
     *
     * @return Result.success con el [androidx.activity.result.IntentSenderRequest] para lanzar la UI.
     ...
     *
     * @param intent El [android.content.Intent] recibido en el callback del [ActivityResultLauncher].
     * @return Un [org.override.docs.data.auth.api.ExternalAuthResult] que encapsula el éxito (con token),
